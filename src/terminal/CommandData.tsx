...
export const getCommandData = (setTerminalMode: (v: boolean) => void): Record<string, React.ReactNode> => ({
  whoami: (
    <>
      ...
      <span>
        Essayez de taper <strong>help</strong> pour voir la liste des commandes.
      </span>
    </>
  ),
  about: (
    <div className="flex flex-col items-start gap-3">
      <div className="flex items-center gap-4">
        ...
        />
        <div>
          <div className="text-lg font-bold">Salut ! Je suis {personalInfo.alias}</div>
  ...
  help: (
    <>
      ...
      <ul className="list-disc ml-4 font-bold">
        ...
        <li>skills</li>
        <li>contact</li>
        <li className="text-brand-caribbean cursor-pointer hover:underline" onClick={() => setTerminalMode(false)}>gui</li>
        <li>clear</li>
        <li>help</li>
      </ul>
    </>
