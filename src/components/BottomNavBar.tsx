...
const navItems = [
  ...
  { name: "Compétences", id: "skills", icon: Target },
            ...
            return (
              <button
                ...
                className={`relative flex items-center justify-center p-3 sm:p-4 rounded-2xl transition-all duration-300 group ${isActive
                  ? "text-brand-caribbean bg-white/10"
              ...
              >
                ...
                {isActive && (
                  <motion.div
                    layoutId="active-dot"
                    className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-1 h-1 bg-brand-caribbean rounded-full"
                  />
                )}
              </button>
            );
